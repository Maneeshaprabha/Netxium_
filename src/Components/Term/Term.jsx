...
const termsData = [
  {
    ...
    content: (
      <>
        <p>
          Welcome to Netxium. These Terms and Conditions govern your use of our
          website, products, and services. By accessing or using our platform,
        ...
        <p>
          Our services are designed to provide cutting-edge AI and software
          solutions. The information provided on this platform is for general
      ...
      <>
        ...
        <ul className="list-none space-y-3 mt-4">
          <li className="flex gap-3">
            <span className="text-[#29AAE3] font-bold">2.1</span> You are
            responsible for safeguarding the password that you use to access the
            Service.
          </li>
          <li className="flex gap-3">
            <span className="text-[#29AAE3] font-bold">2.2</span> You agree not
            to disclose your password to any third party.
          </li>
          <li className="flex gap-3">
            <span className="text-[#29AAE3] font-bold">2.3</span> You must
    ...
    content: (
      <>
        ...
        <p>
          ...
          product or service without the prior written consent of Netxium.
        </p>
      </>
    ),
  },
      ...
      <>
        ...
        <div className="bg-[#F4F7FB] p-6 rounded-2xl border border-gray-100 mt-6">
          <ul className="space-y-3 text-gray-600">
            ...
            <li className="flex items-center gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-red-400" />
              To impersonate or attempt to impersonate Netxium, a Netxium
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          In no event shall Netxium, nor its directors, employees, partners,
